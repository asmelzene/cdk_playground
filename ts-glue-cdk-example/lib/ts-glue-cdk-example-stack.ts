...
export class GlueJobStack2 extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const glueJob = new glue.CfnJob(this, 'GlueJob2', {
      ...
      defaultArguments: {
        '--job-language': 'python',
        '--extra-py-files': `s3://${bucket.bucketName}/wheels/connection/my_connection_package-0.1-py3-none-any.whl,s3://${bucket.bucketName}/wheels/utils/my_utils_package-0.1-py3-none-any.whl`, // Reference to the wheel files
      },
    });
